...
class user_courses_custom_adapter(val course_List: ArrayList<Courses>) : RecyclerView.Adapter<user_courses_custom_adapter.ViewHolder>() {
...
//        val v = LayoutInflater.from(parent.context).inflate(R.layout.custom_recycler_view, parent,false)
        val v = LayoutInflater.from(parent.context).inflate(R.layout.user_courses_cardview_layout, parent,false)
        return ViewHolder(v)
    }
